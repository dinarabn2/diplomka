...
<body class="antialiased">
    <div
        class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center  sm:pt-0 promo-bg">
        <div class="promo-center">
            <div class="promo-block">
                <div class="promo-title">ART MEDIA COMPANY</div>
                <div class="promo-subtitle">Толық циклді жарнама агенттігі</div>
        ...
        <div class="promo-center">
            ...
            <div class="promo-title"> Білім алушылардың <br> әлеуметтік жағдайын есепке алу</div>
            <div class="promo-wrapper">
                <a href="{{ route('login') }}" class="text-sm text-gray-700 underline promo-link">
                    <span>Логин</span>
                </a>

                @if (Route::has('register'))
                <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 underline promo-link">Тіркелу</a>
                @endif
            </div>
            @endif
        </div>
