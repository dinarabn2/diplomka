...
class TutorController extends AppBaseController
{
    ...
    public function store(CreateTutorRequest $request)
    {
        ...
        Flash::success('Жауаптылар сәтті сақталды.');
    ...
    public function show($id)
    {
        ...
        if (empty($tutor)) {
            Flash::error('Жауаптылар табылмады');
    ...
    public function update($id, UpdateTutorRequest $request)
    {
        ...
        Flash::success('Жауаптылар сәтті жаңартылды.');
    ...
    public function destroy($id)
    {
        ...
        Flash::success('Жауаптылар сәтті жойылды.');
